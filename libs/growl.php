...
Orginally written by: Tyler Hall (http://clickontyler.com/php-growl/)
Licensed under MIT

Github page: http://github.com/tylerhall/php-growl/


This file has been modeified by A.J. Cates for use in his Sweet-Framework.
*/
...
/*
            if(function_exists('socket_create') && function_exists('socket_sendto'))
            {
                ...
                socket_set_option($sck, SOL_SOCKET, SO_BROADCAST, 1);

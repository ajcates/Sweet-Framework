...
#Unit Test Library for Sweet-Framework


##Needs:
	- to make test's portable.
	- use my framework, lol im lazy.
	- could be launched via test.php in the index of the sweet-framework
		- 
	...
	function loadTestPage() {
		...
		B::get('xhtml5', array(
			...
			'body' => B::body(
				...
				B::div(
					array('class' => 'main'),
					array() //recursive test array call.
				),
				B::footer('SweetFramework')
			)
		));		
